    ...
    <div v-show="showFlag" class="food" ref="food">
      <div class="food-content">
        ...
        <div class="rating">
          ...
          <ratingselect @select="ratingtype" @toggle="toggleContent" :select-type="selectType" :only-content="onlyContent" :desc="desc" :ratings="food.ratings"></ratingselect>
...
<style>
  ...
  .food .buy.fade-enter-active,
  .food .buy.fade-leave-active {
    transform: all 0.2s;
  }
